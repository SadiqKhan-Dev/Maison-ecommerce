...
export const metadata: Metadata = {
  title: "Teen (12–16)",
  description:
    "Transitional teen clothing. Style-forward pieces that bridge childhood and adulthood.",
};

export default async function ChildrenTeenPage({
  searchParams,
}: {
  ...
  const categoryProducts = mockProducts.filter(
    (p) => p.category === "CHILDREN" && p.subCategory === "Teen"
  );
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1503341504253-dff4815485f1?auto=format&fit=crop&w=2000&q=80&seed=children-teen')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Style-forward transitional pieces that bridge childhood and adulthood.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="CHILDREN" active="Teen" />
        ...
        <div className="grid lg:grid-cols-[260px_1fr] gap-10 lg:gap-14">
          ...
          <div>
            ...
            {items.length === 0 ? (
              <EmptyState
                title="No teen products in this view"
