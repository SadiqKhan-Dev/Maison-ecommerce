...
export const metadata: Metadata = {
  title: "Kids (5–12)",
  description:
    "Organic cotton kids clothing. Comfortable, sustainable everyday wear for growing children.",
};

export default async function ChildrenKidsPage({
  searchParams,
}: {
  ...
  const categoryProducts = mockProducts.filter(
    (p) => p.category === "CHILDREN" && p.subCategory === "Kids"
  );
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?auto=format&fit=crop&w=2000&q=80&seed=children-kids')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Organic cotton everyday wear, comfortable and sustainable for growing children.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="CHILDREN" active="Kids" />
        ...
        <div className="grid lg:grid-cols-[260px_1fr] gap-10 lg:gap-14">
          ...
          <div>
            ...
            {items.length === 0 ? (
              <EmptyState
                title="No kids products in this view"
