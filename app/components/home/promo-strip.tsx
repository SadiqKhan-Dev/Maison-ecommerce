      ...
      <div className="container-app py-16 lg:py-24 grid lg:grid-cols-12 gap-8 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/products"
              className="inline-flex items-center h-12 px-8 border border-background/30 text-xs uppercase tracking-[0.2em] font-medium rounded-full hover:bg-background hover:text-foreground hover:border-background transition-colors"
            >
              All categories
            </Link>
          </div>
