...
export const metadata: Metadata = {
  ...
  description:
    "Coats and jackets. Layered womenswear crafted from premium materials.",
};

export default async function WomenOuterwearPage({
  searchParams,
}: {
  ...
  params.set("sub", "Outerwear");
  const filters = parseFilters(params);

  const categoryProducts = mockProducts.filter(
    (p) => p.category === "WOMEN" && p.subCategory === "Outerwear"
  );
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1539533018447-63fcce2678e3?auto=format&fit=crop&w=2000&q=80&seed=women-outerwear')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Coats and jackets crafted from premium materials for layered elegance.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="WOMEN" active="Outerwear" />
        ...
        <div className="grid lg:grid-cols-[260px_1fr] gap-10 lg:gap-14">
          ...
          <div>
            ...
            {items.length === 0 ? (
              <EmptyState
                title="No outerwear in this view"
