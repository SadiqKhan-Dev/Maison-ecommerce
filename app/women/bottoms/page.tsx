...
export const metadata: Metadata = {
  ...
  description:
    "Jeans, trousers, and skirts. Precision-cut womenswear for every occasion.",
};

export default async function WomenBottomsPage({
  searchParams,
}: {
  ...
  const categoryProducts = mockProducts.filter(
    (p) => p.category === "WOMEN" && p.subCategory === "Bottoms"
  );
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=2000&q=80&seed=women-bottoms')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Jeans, trousers, and skirts precision-cut for a modern silhouette.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="WOMEN" active="Bottoms" />
