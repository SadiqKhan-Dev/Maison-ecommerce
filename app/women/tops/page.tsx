...
export const metadata: Metadata = {
  title: "Women's Tops",
  description:
    "Blouses, sweaters, and knitwear. Considered womenswear crafted from fine natural fibers.",
};
...
export default async function WomenTopsPage({
  ...
  const categoryProducts = mockProducts.filter(
    (p) => p.category === "WOMEN" && p.subCategory === "Tops"
  );
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1434389677669-e08b4cac3105?auto=format&fit=crop&w=2000&q=80&seed=women-tops')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Blouses, sweaters, and knitwear crafted from fine natural fibers.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="WOMEN" active="Tops" />
