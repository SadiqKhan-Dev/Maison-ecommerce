...
export const metadata: Metadata = {
  ...
  description:
    "Boots, loafers, and heels. Refined womenswear for every step.",
};

export default async function WomenFootwearPage({
  searchParams,
}: {
  ...
  params.set("sub", "Footwear");
  const filters = parseFilters(params);

  const categoryProducts = mockProducts.filter(
    (p) => p.category === "WOMEN" && p.subCategory === "Footwear"
  );
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=2000&q=80&seed=women-footwear')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Boots, loafers, and heels crafted for every step.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="WOMEN" active="Footwear" />
        ...
        <div className="grid lg:grid-cols-[260px_1fr] gap-10 lg:gap-14">
          ...
          <div>
            ...
            {items.length === 0 ? (
              <EmptyState
                title="No footwear in this view"
