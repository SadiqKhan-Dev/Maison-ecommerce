...
export const metadata: Metadata = {
  title: "Men's Tops",
  description:
    "Shirts, sweaters, and essential layers. Considered menswear crafted from fine natural fibers.",
};

export default async function MenTopsPage({
  searchParams,
}: {
  ...
  const categoryProducts = mockProducts.filter(
    (p) => p.category === "MEN" && p.subCategory === "Tops"
  );
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?auto=format&fit=crop&w=2000&q=80&seed=men-tops')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Shirts, sweaters, and essential layers crafted from fine natural fibers.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="MEN" active="Tops" />
