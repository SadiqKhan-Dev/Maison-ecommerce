...
export const metadata: Metadata = {
  ...
  description:
    "Shoes, boots, and sneakers. Goodyear-welted and hand-finished craftsmanship.",
};

export default async function MenFootwearPage({
  searchParams,
}: {
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1614252369475-531eba835eb1?auto=format&fit=crop&w=2000&q=80&seed=men-footwear')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Goodyear-welted shoes and hand-finished boots built to last.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="MEN" active="Footwear" />
