...
export const metadata: Metadata = {
  ...
  description:
    "Coats, jackets, and layers built to endure. Statement outerwear for every season.",
};

export default async function MenOuterwearPage({
  searchParams,
}: {
    ...
    <>
      <section className="relative h-[50vh] min-h-[360px] overflow-hidden bg-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=2000&q=80&seed=men-outerwear')",
        ...
        <div className="relative h-full container-app flex flex-col justify-end pb-12 text-background">
          ...
          <p className="text-sm lg:text-base opacity-80 max-w-md">
            Coats, jackets, and layers built to endure every season.
          </p>
        </div>
      </section>
      ...
      <Container className="py-10 lg:py-14">
        ...
        <SubCategoryNav category="MEN" active="Outerwear" />
